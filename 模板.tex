...
\lstset{language = C++, basicstyle = \footnotesize\SourceCodePro, numbers = left, numberstyle = \footnotesize\SourceCodePro, frame = single, keywordstyle = \color{blue}, stringstyle = \color{red}, commentstyle = \color{gray}}
\section{算法}
\subsection{字符串算法}
\subsubsection{最小表示}
\begin{lstlisting}
...
\end{lstlisting}
\subsubsection{快速Walsh-Hadamard变换（与）}
\begin{lstlisting}
#include <bits/stdc++.h>
using namespace std;
const int N = 100001;
...
\end{lstlisting}
\section{其他}
\lstset{language = Java, basicstyle = \footnotesize\SourceCodePro, numbers = left, numberstyle = \footnotesize\SourceCodePro, frame = single, keywordstyle = \color{blue}, stringstyle = \color{red}, commentstyle = \color{gray}}
...
\end{lstlisting}
\lstset{language = lisp, basicstyle = \footnotesize\SourceCodePro, numbers = left, numberstyle = \footnotesize\SourceCodePro, frame = single, keywordstyle = \color{blue}, stringstyle = \color{red}, commentstyle = \color{gray}}
\subsection{Emacs配置}
\begin{lstlisting}
;;括号补全
